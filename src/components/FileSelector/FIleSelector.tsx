...
const FileSelector: React.FC<FileSelectorProps> = ({ id, onSelect }) => {
  ...
  return (
    <div className="relative mt-2 rounded-md shadow-sm flex space-x-4">
      <input type="text" name="price" className="block w-1/2 rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder={placeholder} value={fileName} />
